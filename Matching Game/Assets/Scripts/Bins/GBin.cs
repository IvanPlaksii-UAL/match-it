...
public class GBin : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (reftoManager.currentPos == "Square") this.transform.position = new Vector3(7.5f, 0, 0);
        else this.transform.position = new Vector3(15, 0, 0);

        reftoManager.PointCheck(Green, true, gameObject);
