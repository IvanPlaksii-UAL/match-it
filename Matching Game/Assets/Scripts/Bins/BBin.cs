...
public class BBin : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (reftoManager.currentPos == "Hexagon") this.transform.position = new Vector3(7.5f, 0, 0);
        ...
        reftoManager.PointCheck(Blue, true, gameObject);
